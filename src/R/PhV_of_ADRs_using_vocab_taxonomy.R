...
#' 
#' Each ADR takes into account ADRs of descendants as well
#' 
...
#' 
#' source ../bash/submit_Rjob_3arg.sh PhV_of_ADRs_using_vocab_taxonomy.R "ANTIEPILEPTICS" 3 "dev_age_cat" > PhV_of_ADRs_using_vocab_taxonomy.log
#' 
#' 
#' EXAMPLE RUN ON LOCAL:
#' ---------------------
#' 
#' Rscript PhV_of_ADRs_using_vocab_taxonomy.R "ANTIEPILEPTICS" 3 "dev_age_cat"
